...
def main()->int:
        ...
        for iteration in range(SOURCE_ITERATION+1,TARGET_ITERATION+1):
            ...
            if checkpoint_due:
                ...
                if completed==MILESTONE_ITERATION:
                    ...
                    print(
                        "LT3_PARALLEL_MILESTONE_8600_PRESERVED "
    ...
    if source_hashes_after!=source_hashes_before:
        raise RuntimeError("source 8200 artifacts changed during continuation")
    ...
    if milestone_files:
        print(f"milestone_8600_checkpoint={milestone_files['checkpoint']}")
        print(f"milestone_8600_ensemble={milestone_files['ensemble']}")
    return 0
