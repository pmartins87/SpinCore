...
from spincore.r7_5_eval_artifacts import EXPECTED_EXECUTION_SHA
...
def main() -> int:
    ...
    if args.execution_sha != EXPECTED_EXECUTION_SHA:
        raise ValueError("cross-seed worker execution SHA differs from frozen training run")
    ...
    report["execution_sha"] = args.execution_sha
